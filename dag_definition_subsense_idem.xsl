...
<xsl:template name="definition_subsense_idem_extern">
...
<xsl:otherwise>deaf:error_in_the_main-lemma-sub-lemma_structure</xsl:otherwise>
  ...
  <xsl:for-each select="preceding-sibling::m:usage | following-sibling::m:usage | ../following-sibling::m:usage | ../preceding-sibling::m:usage"><xsl:call-template name="usage_extern"/></xsl:for-each>
  <xsl:for-each select="preceding-sibling::m:terminology | following-sibling::m:terminology | ../following-sibling::m:terminology | ../preceding-sibling::m:terminology"><xsl:call-template name="terminology_extern"/></xsl:for-each>rdfs:comment "DEAF article <xsl:choose><xsl:when test="../../../../../..[@type='mainpart']">
  <xsl:value-of select="//part[@type='mainpart']/title/lemma"/></xsl:when>
  <xsl:when test="../../../../../..[@type='subpart']">
