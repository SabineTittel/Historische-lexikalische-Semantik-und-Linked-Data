...
<xsl:when test="./@language='anglolt.'">"anglo-latin"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
...
<xsl:when test="./@language='aouestnord.'">"ancien ouest-nordique"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
...
<xsl:when test="./@language='frq.'">"francique rhénan"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
...
<xsl:when test="./@language='gallolt.'">"gallolatin"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
<xsl:when test="./@language='gallorom.'">"galloroman"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
...
<xsl:when test="./@language='hit.'">"haut-italien"@fr ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned??</xsl:when>
...
<xsl:when test="./@language='lgb.'">"longobard"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
...
<xsl:when test="./@language='lt.chrét.'">"latin chrétien"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
<xsl:when test="./@language='lt.cl.'">"latin classique"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
<xsl:when test="./@language='lt.tard.'">"latin tardif"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
<xsl:when test="./@language='lt.vulg.'">"latin vulgaire"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
...
<xsl:when test="./@language='mlt.'">"moyen latin"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
...
<xsl:when test="./@language='prérom.'">"protoroman"@fr , lexvo:unassigned ;
  rdfs:label "<xsl:value-of select="lower-case(.)"/>"@unassigned</xsl:when>
