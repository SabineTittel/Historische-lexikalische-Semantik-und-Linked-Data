...
<!--<xsl:variable name="lemma_name_stripped">
	  <xsl:copy-of select="translate($lemma_name, '[^0-9]', '')"/>
</xsl:variable>-->
...
</xsl:for-each><xsl:for-each select="m:cited-word[@index='e'][position()>1]">
